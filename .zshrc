...
setopt auto_cd
cdpath=(/Users/mikeurbanski/Documents/AWS /Users/mikeurbanski/Documents/AWS/sre-infra /Users/mikeurbanski/Documents/AWS/ /Users/mikeurbanski/)
...
AWS_ACCESS_KEY_public=REDACTED
AWS_SECRET_public="REDACTED"

AWS_MFA_KEY_public="REDACTED"
...
aws-auth-simple() {
	...
	if [[ "$1" == "public" ]]; then
		__SERIAL="$AWS_MFA_KEY_public"
	elif [[ "$1" == "personal" ]]; then
		__SERIAL="$AWS_MFA_KEY_personal"
	else
